...
function chore(over: Partial<Chore>): Chore {
  return { id: 'c1', family_id: 'f', title: 'זבל', note: null, icon: 'trash', points: 1, assigned_to: null, is_shower: false, track_only: false, per_day: 1, days: null, turn_taking: false, single_daily: false, active: true, sort: 0, ...over }
}
